...
<div class="container mx-auto py-8 px-4">
	<section class="container grid items-center gap-6">
		<div class="flex max-w-[980px] flex-col items-start gap-2">
			...
			<h3>Comment?</h3>
			<p>L'inscription et l'utilisation sont gratuite pour tous les producteur afin de n'en laisser aucun de côté.</p>
			...
			<p>Nous avons le projet de créer un label pour mettre un peu plus en valeur les producteurs qui jouent la carte de la transparence. Il permet au conssomateur d'avoir une certaine garanti que la production est réellement locale. En effet, certains peuvent être tentés d'importer les produits et de faire localement qu'une infime partie du travail.</p>
